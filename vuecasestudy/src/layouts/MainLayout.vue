        ...
        <q-btn flat round dense icon="reorder" class="q-mr-xs">
          <q-menu>
            <q-list style="min-width: 100px">
              ...
              <q-item clickable v-close-popup to="map">
                <q-item-section>Branches</q-item-section>
              </q-item>
              <q-item clickable v-close-popup to="cart">
                <q-item-section>Cart</q-item-section>
              </q-item>
              <q-item clickable v-close-popup to="order-history">
      ...
      <q-toolbar>
        <q-toolbar-title>
          <div class="text-subtitle2">
            best viewed on mobile device — Abdul Marouf &copy;{{ new Date().getFullYear() }}
          </div>
        </q-toolbar-title>
      </q-toolbar>
    </q-footer>

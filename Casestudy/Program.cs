...
builder.Configuration.AddJsonFile("appsettingsLocal.json", optional: true, reloadOnChange: true);
...
// Ensure appSettings is not null before using it  
if (string.IsNullOrEmpty(appSettings))
{
    throw new InvalidOperationException("AppSettings:Secret is not configured in the application settings.");
}
